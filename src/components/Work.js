            ...
            <h2 className="w3-text-grey w3-padding-16"><i className="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>My Notable Projects</h2>
                {
                    work.map(
                        ...
                        <h5 className="w3-opacity"><b>{project.title}</b>/<b><a href={project.link} target="_blank"><i className="fa fa-hand-o-right fa-fw w3-large w3-text-teal"></i>{project.linkname}</a></b></h5>
