...
export const education = [
    ...
    time: '2013-2015',
    course:'Completed +2 with Management'
    },
    {
    schoolname: 'Nepal Police Higher Secondary Boarding School',
    time: '2013',
    course:'SLC'
    },
] 
...
export const languages = [
    ...
    {title:'Wordpress', proeficiency: '45%'},
]

export const skills = [
    {title:'Punctual', proeficiency: '95%'},
    {title:'Management skills', proeficiency: '90%'},
